...
| 模块 | 功能 | Git 引用 |
|------|------|----------|
| `com.coffeebean.core` | 模块管理 / 引导 / 服务注册 | `https://github.com/Herschy0829/com.coffeebean.core.git#v0.1.16` |
| `com.coffeebean.events` | 事件系统（EventBus 轻量 + EventCenter 受管） | `https://github.com/Herschy0829/com.coffeebean.events.git#v0.2.1` |
| `com.coffeebean.excel` | Excel 配置表工具链（Editor-only：多 Sheet/分章节/读取/推断/生成 JSON+C# 类+Getter） | `https://github.com/Herschy0829/com.coffeebean.excel.git#v0.1.1` |
